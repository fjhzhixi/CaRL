...
append_if_set "USE_CAMERA" "--use_camera"
append_if_set "CAMERA_MODE" "--camera_mode"
append_if_set "CAMERA_WIDTH" "--camera_width"
append_if_set "CAMERA_HEIGHT" "--camera_height"
append_if_set "IMAGE_ENCODER_CKPT" "--image_encoder_ckpt"
