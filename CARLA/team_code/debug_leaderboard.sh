python ${LEADERBOARD_ROOT}/leaderboard/leaderboard_evaluator.py \
    ...
    --agent ${WORK_DIR}/team_code/env_agent.py --resume 0 --checkpoint ${WORK_DIR}/results/debug/config.json \
    --track MAP --port 2000 --traffic-manager-port 8000 --agent-config ${WORK_DIR}/results/debug/PPO_debug \
